...
#define OS2      1      /* For IBM OS/2 2.0 using EMX GCC                  */
...
#define DEF_EDITOR         "tedit"              /* replace with ((char *)0)*/
#define DEF_EDITLINE       "tedit"              /* if no default editor rqd*/

/* hier folgen die ursprnglichen Werte: */
